...
public class ClientaEmbarazada extends Cliente {

    public ClientaEmbarazada() {
        super();
    ...
    public int calculaTiempoEspera() {
        ...
        tiempoTipoCliente = (int) (tiempoArticulos * 0.20);
    ...
    public String toString() {
        return "ClientaEmbarazada{"+ super.toString() +'}';
    }
